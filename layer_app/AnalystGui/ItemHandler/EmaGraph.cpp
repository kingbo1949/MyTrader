...
bool CEmaGraph::MakeMap(const CodeStr& codeId, Time_Type timetype, const IBKLinePtrs& klines, int beginPos)
{
	...
	IBAvgValuePtrs avgValues = MakeAndGet_QDatabase()->GetEmas(codeId, timetype, query);
