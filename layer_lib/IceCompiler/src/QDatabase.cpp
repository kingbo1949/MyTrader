...
const ::std::string iceC_IBTrader_IQDatabase_GetLastDayKLine_name = "GetLastDayKLine";
...
/// \cond INTERNAL
bool
IBTrader::IQDatabase::_iceD_GetLastDayKLine(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    ::std::string iceP_codeId;
    long long int iceP_msTime;
    istr->readAll(iceP_codeId, iceP_msTime);
    inS.endReadParams();
    IKLine iceP_kline;
    bool ret = this->GetLastDayKLine(::std::move(iceP_codeId), iceP_msTime, iceP_kline, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(iceP_kline, ret);
    inS.endWriteParams();
    return true;
...
IBTrader::IQDatabase::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - iceC_IBTrader_IQDatabase_ops)
    {
        ...
        case 7:
        {
            return _iceD_GetLastDayKLine(in, current);
        }
        case 8:
        {
...
/// \cond INTERNAL
void
IBTrader::IQDatabasePrx::_iceI_GetLastDayKLine(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<IQDatabase::GetLastDayKLineResult>>& outAsync, const ::std::string& iceP_codeId, long long int iceP_msTime, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_IBTrader_IQDatabase_GetLastDayKLine_name);
    outAsync->invoke(iceC_IBTrader_IQDatabase_GetLastDayKLine_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_codeId, iceP_msTime);
        },
        nullptr,
        [](::Ice::InputStream* istr)
        {
            IQDatabase::GetLastDayKLineResult v;
            istr->readAll(v.kline, v.returnValue);
            return v;
        });
}
...
::Ice::AsyncResultPtr
IceProxy::IBTrader::IQDatabase::_iceI_begin_GetLastDayKLine(const ::std::string& iceP_codeId, ::Ice::Long iceP_msTime, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_IBTrader_IQDatabase_GetLastDayKLine_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_IBTrader_IQDatabase_GetLastDayKLine_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_IBTrader_IQDatabase_GetLastDayKLine_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_codeId);
        ostr->write(iceP_msTime);
        result->endWriteParams();
        result->invoke(iceC_IBTrader_IQDatabase_GetLastDayKLine_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
bool
IceProxy::IBTrader::IQDatabase::end_GetLastDayKLine(::IBTrader::IKLine& iceP_kline, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_IBTrader_IQDatabase_GetLastDayKLine_name);
    bool ret;
    if(!result->_waitForResponse())
    {
        try
...
void IceProxy::IBTrader::IQDatabase::_iceI_end_GetLastDayKLine(::IBTrader::IKLine& iceP_kline, bool& ret, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_IBTrader_IQDatabase_GetLastDayKLine_name);
    if(!result->_waitForResponse())
    {
...
IBTrader::IQDatabase::_iceD_GetLastDayKLine(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::Ice::InputStream* istr = inS.startReadParams();
    ::std::string iceP_codeId;
    ::Ice::Long iceP_msTime;
    istr->read(iceP_codeId);
    istr->read(iceP_msTime);
    inS.endReadParams();
    IKLine iceP_kline;
    bool ret = this->GetLastDayKLine(iceP_codeId, iceP_msTime, iceP_kline, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(iceP_kline);
    ostr->write(ret);
    inS.endWriteParams();
