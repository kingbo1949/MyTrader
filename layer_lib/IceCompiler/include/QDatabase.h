...
public:
    ...
    /**
     * Encapsulates the results of a call to GetLastDayKLine.
     */
    struct GetLastDayKLineResult
    {
        bool returnValue;
        IKLine kline;
    };

    virtual bool GetLastDayKLine(::std::string codeId, long long int msTime, IKLine& kline, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_GetLastDayKLine(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    {
        auto _result = _makePromiseOutgoing<IQDatabase::GetLastDayKLineResult>(true, this, &IQDatabasePrx::_iceI_GetLastDayKLine, codeId, msTime, context).get();
        kline = ::std::move(_result.kline);
        return _result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto GetLastDayKLineAsync(const ::std::string& codeId, long long int msTime, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<IQDatabase::GetLastDayKLineResult>>().get_future())
    {
        return _makePromiseOutgoing<IQDatabase::GetLastDayKLineResult, P>(false, this, &IQDatabasePrx::_iceI_GetLastDayKLine, codeId, msTime, context);
    }

    ::std::function<void()>
    GetLastDayKLineAsync(const ::std::string& codeId, long long int msTime,
                         ::std::function<void(bool, ::IBTrader::IKLine)> response,
                         ::std::function<void(::std::exception_ptr)> ex = nullptr,
                         ::std::function<void(bool)> sent = nullptr,
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](IQDatabase::GetLastDayKLineResult&& _result)
        {
            response(_result.returnValue, ::std::move(_result.kline));
        };
        return _makeLamdaOutgoing<IQDatabase::GetLastDayKLineResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &IBTrader::IQDatabasePrx::_iceI_GetLastDayKLine, codeId, msTime, context);
    }

    /// \cond INTERNAL
    void _iceI_GetLastDayKLine(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<IQDatabase::GetLastDayKLineResult>>&, const ::std::string&, long long int, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::IBTrader::IQDatabase::begin_GetLastDayKLine.
 * Create a wrapper instance by calling ::IBTrader::newCallback_IQDatabase_GetLastDayKLine.
 */
class Callback_IQDatabase_GetLastDayKLine_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_IQDatabase_GetLastDayKLine_Base> Callback_IQDatabase_GetLastDayKLinePtr;
...
public:
    ...
    bool GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, ::IBTrader::IKLine& kline, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_GetLastDayKLine(kline, _iceI_begin_GetLastDayKLine(codeId, msTime, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_GetLastDayKLine(codeId, msTime, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_GetLastDayKLine(codeId, msTime, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_GetLastDayKLine(codeId, msTime, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, const ::IBTrader::Callback_IQDatabase_GetLastDayKLinePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_GetLastDayKLine(codeId, msTime, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, const ::Ice::Context& context, const ::IBTrader::Callback_IQDatabase_GetLastDayKLinePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_GetLastDayKLine(codeId, msTime, context, cb, cookie);
    }

    bool end_GetLastDayKLine(::IBTrader::IKLine& kline, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_GetLastDayKLine(::IBTrader::IKLine& iceP_kline, bool& ret, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_GetLastDayKLine(const ::std::string&, ::Ice::Long, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual bool GetLastDayKLine(const ::std::string& codeId, ::Ice::Long msTime, IKLine& kline, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_GetLastDayKLine(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_IQDatabase_GetLastDayKLine : public Callback_IQDatabase_GetLastDayKLine_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_IQDatabase_GetLastDayKLine(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            ret = proxy->end_GetLastDayKLine(iceP_kline, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::IBTrader::IQDatabase::begin_GetLastDayKLine.
 */
template<class T> Callback_IQDatabase_GetLastDayKLinePtr
newCallback_IQDatabase_GetLastDayKLine(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const IKLine&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_IQDatabase_GetLastDayKLine<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_IQDatabase_GetLastDayKLinePtr
newCallback_IQDatabase_GetLastDayKLine(T* instance, void (T::*cb)(bool, const IKLine&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_IQDatabase_GetLastDayKLine<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_IQDatabase_GetLastDayKLine : public Callback_IQDatabase_GetLastDayKLine_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_IQDatabase_GetLastDayKLine(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::IBTrader::IQDatabase::begin_GetLastDayKLine.
 */
template<class T, typename CT> Callback_IQDatabase_GetLastDayKLinePtr
newCallback_IQDatabase_GetLastDayKLine(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const IKLine&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_IQDatabase_GetLastDayKLine<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_IQDatabase_GetLastDayKLinePtr
newCallback_IQDatabase_GetLastDayKLine(T* instance, void (T::*cb)(bool, const IKLine&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_IQDatabase_GetLastDayKLine<T, CT>(instance, cb, excb, sentcb);
}
